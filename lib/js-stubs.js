// https://emscripten.org/docs/porting/connecting_cpp_and_javascript/Interacting-with-code.html?highlight=addtolibrary#javascript-limits-in-library-files
addToLibrary({
    ...
    duckdb_web_fs_file_read__sig: 'iipidp',
    duckdb_web_fs_file_read: function (fileId, buf, size, location, asyncResultBuf) {
        return globalThis.DUCKDB_RUNTIME.readFile(Module, fileId, buf, size, location, asyncResultBuf);
    },
